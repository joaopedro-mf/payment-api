namespace tech_test_payment_api.Presentation.Extensions;
...
public static class ProgramExtensions
{
    ...
    public static WebApplication ConfigureApplication(this WebApplication app)
    {
        ...
        _ = app.UseSwagger();
        _ = app.UseSwaggerUI(c => c.SwaggerEndpoint("/swagger/v1/swagger.json", $"tech_test_payment_api - {ti.ToTitleCase(app.Environment.EnvironmentName)} - V1"));
